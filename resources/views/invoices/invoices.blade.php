                        ...
                        <div class="col-xl-12">
                            <div class="card mg-b-20">
                                <div class="card-header pb-0">
                                    ...
                                    <a class="btn ripple btn-primary" href="{{ url('export_invoices') }}"
                                                        ...
                                                        <td>
                                                            <div class="dropdown">
                                                                ...
                                                                <div class="dropdown-menu tx-13">
                                                                        ...
                                                                        <a class="dropdown-item" href="status_show/{{$invoice->id}}"
                                                                            ><i
