<!-- main-sidebar -->
		...
		<aside class="app-sidebar sidebar-scroll">
			...
			<div class="main-sidemenu">
				...
				<ul class="side-menu">
					<li class="side-item side-item-category">فواتيري</li>
					<li class="slide">
					...
					<li class="slide">
						...
						<ul class="slide-menu">
							...
							<li><a class="slide-item" href="{{ url('/partial_paid') }}">الفواتير المدفوعة جزئيًا</a></li>
                            <li><a class="slide-item" href="{{ url('/archieve') }}">أرشيف الفواتير</a></li>
						</ul>
					</li>
